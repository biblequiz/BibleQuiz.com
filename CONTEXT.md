...
**Newsletter Issue** — The monthly source communication from AG Youth Ministries containing Teen Bible Quiz news, dates, resources, and contact information.
_Avoid_: Email, PDF

**Newsletter Post** — The text-first, web-native publication of a Newsletter Issue in the BibleQuiz.com news collection. It preserves the issue's substantive information without email chrome or decorative artwork.
_Avoid_: Newsletter upload, PDF post
