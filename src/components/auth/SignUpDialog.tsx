...
export default function SignUpDialog({ isOpen }: Props) {
    ...
    return (
        <Dialog isOpen={isOpen}>
            <h3 className="font-bold text-lg mb-4">Sign Up for Account</h3>
            <form id="registrationForm" className="space-y-6" onSubmit={handleSubmit}>
                <div>
                    Now that you have logged in, we need a few additional details to complete the setup of your account.
                </div>
