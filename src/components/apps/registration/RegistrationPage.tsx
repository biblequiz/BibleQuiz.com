...
import { EventFieldScopes } from "types/services/EventsService";
import type { RegistrationPerson, RegistrationOfficial, RegistrationTeam } from "types/services/RegistrationService";
