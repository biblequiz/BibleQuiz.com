...
For the Challenger Division, [real-time results are here](/tbq/seasons/2021/nationals#challenger-results). (Please note that the "Ghost Team" that appears at the top of the standings is a filler for the bye-round situation and should be disregarded.)
