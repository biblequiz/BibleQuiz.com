...
<LinkButton href="/assets/2025/nationals/indiv-tournament-bracket.pdf">View Tournament Bracket</LinkButton>
<LinkButton href="/assets/2025/nationals/indiv-tournament-by-name.pdf">Seeding by Quizzer Name</LinkButton>
<LinkButton href="/assets/2025/nationals/indiv-tournament-by-room.pdf">Seeding by Room</LinkButton>
...
4. For round one, quizzers will use their seeding number and the format [in the bracket](/assets/2025/nationals/indiv-tournament-bracket.pdf) to determine their starting room.
...
6. If a tie occurs, the following rules apply:
   1. A two-way tie for second will be broken by the normal tie-breaking rules.
   ...
   3. If a tie occurs and one or more quizzers are ineligible, those who have quizzed out will be allowed back in to break the tie while those who struck out or fouled out will remain ineligible.
   4. If a tie occurs between quizzers who have struck out or fouled out, the tie will be broken by the normal rules.
