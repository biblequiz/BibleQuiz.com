...
The questions this upcoming season are designed to be hit quickly. The exceptions are Scripture Text
Questions (as with most writers) and questions that start with "According to".

**The more word-perfect quizzers know the material, the better chance they have at getting questions right.**

**This not only applies to Quotation / Essence Questions, but it also increases the chances of finding the
key word(s) used in the question itself**. To get ahead in studying, quizzers should also note the following:
- "of" phrases
- Adjectives
- Unique words
