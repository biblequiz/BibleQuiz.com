...
description: "Scoring, coaching, study, and event tools for Bible Quiz."
resource:
  programs: [shared]
...
import AppDownloadCardDeck from 'components/AppDownloadCardDeck';
...
<Card>
    ...
    <AppDownloadCardDeck product="CoachApp" />
...
<Card>
    ...
    <AppDownloadCardDeck product="EZScore" />
...
<Card>
    ...
    <AppDownloadCardDeck product="ScoreKeep" />
...
### How do I include my schedules and scores for [Upcoming & Live Events](https://biblequiz.com)?
