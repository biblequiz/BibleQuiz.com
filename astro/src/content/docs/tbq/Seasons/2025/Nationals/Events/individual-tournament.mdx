...
<LinkButton href="/assets/2025/indiv-tournament-bracket.pdf">View Tournament Bracket</LinkButton>
...
4. For round one, quizzers will use their seeding number and the format [in the bracket](/assets/2025/indiv-tournament-bracket.pdf) to determine their starting room.
