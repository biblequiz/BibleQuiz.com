...
## Remove the Reference Question

For many years, the Reference Question has been problematic for a [number of reasons](/tbq/seasons/2023/updated-rules/why-the-reference-question-is-changing). To solve these problems, we've removed the Reference Question introductory remark in favor of a new introductory remark that gives information about the _location_ of the answers instead of the _question_.
...
## Add "From separate verses" introductory remark
...
See [page 25 of the Bible Quiz Rules](/assets/2023/2023-tbq-rules.pdf) for the complete list of rules pertaining to this introductory remark.

* * *

## Simplify the syntax of introductory remarks
