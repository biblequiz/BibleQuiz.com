...
sidebar:
  ...
  order: -60
---
import CollapsableSection from '@components/CollapsableSection.astro';

## Getting Started

<CollapsableSection title="What book(s) are we quizzing over?">
...
<CollapsableSection title="How to Start a Bible Quiz Team">
...
<CollapsableSection title="Ordering Materials">
  Check out the [products](/tbq/products) and [questions](/tbq/questions) posts.
</CollapsableSection>

## General Coaching

<CollapsableSection title="Getting quizzers to study">
...
<CollapsableSection title="Checking off chapters">
...
<CollapsableSection title="Yogi Berra's Coaching Tips">
...
<CollapsableSection title="What Coaches Can't Do">
...
<CollapsableSection title="Preparation">
...
<CollapsableSection title="Motivation">
...
<CollapsableSection title="Transitioning from MSQ to A">
...
<CollapsableSection title="Anticipating interruptions">
...
<CollapsableSection title="Hitting 10s">
...
<CollapsableSection title="Hitting 'describe' questions">
...
<CollapsableSection title="Hitting 20-point 'complete answer' questions">
...
<CollapsableSection title="Hitting chapter analysis questions">
...
<CollapsableSection title="Hitting scripture text questions">
...
<CollapsableSection title="Drill: The Perfect Team">
...
<CollapsableSection title="Drill: Offense/Defense">
...
<CollapsableSection title="Drill: Analysis">
...
<CollapsableSection title="The best reread strategies">
...
<CollapsableSection title="Quizzing with two wrong">
...
<CollapsableSection title="How well should I know the rules?">
...
<CollapsableSection title="Good contesting is R.A.R.E.">
  ### Rules
...
<CollapsableSection title="Responding to a contest">
...
<CollapsableSection title="Concordance Work, Part 1">
...
<CollapsableSection title="Concordance Work, Part 2">
...
<CollapsableSection title="Concordance Work, Part 3">
