...
tags:
  - site-updates
cover:
  image: /public/assets/blog/2023/covers/10-23-newsletter.jpg
  alt: Cover Image
---
...
## JBQ Content
Junior Bible Quiz (JBQ) registration has been active for several years on BibleQuiz.com. Now we have added upcoming event information, live stats, and JBQ Nationals history ([going back to 2009]({{ site.url }}/jbq/seasons/2009/nationals).
...
The [Registration site](https://registration.biblequiz.com) has been in use for years to help teams register and simplify collecting all the information for coordinators, including integrating with [ScoreKeep]({{ site.url }}/apps). With the latest changes, it's never been easier to find the stats and schedules for your events. Just visit the Upcoming and Live Event page for [JBQ]({{ site.url }}/upcoming-events/jbq) and [TBQ]({{ site.url }}/upcoming-events/tbq).

Coordinators can include their events by following [these instructions]({{ site.url }}/apps/training).
...
Go to the [Quizzer Search page]({{ site.url }}/quizzers) (available from the History page of either [JBQ]({{ site.url }}/jbq) or [TBQ]({{ site.url }}/tbq/seasons)). In the search bar at the top, type in the quizzer's name and hit Search. 
...
Built by a coach and developer, CoachApp makes it easy for coaches to keep score, lookup answers, research data, see the rules, and get the online schedule for any registered competition on BibleQuiz.com. [Free to download on the Apps page]({{ site.url }}/apps).
