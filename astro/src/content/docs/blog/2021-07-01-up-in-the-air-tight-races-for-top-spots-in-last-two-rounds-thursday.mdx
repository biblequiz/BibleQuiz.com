...
Real-time results Thursday morning can be found here for the Championship Division: [{{ site.url }}{{ site.baseurl }}/tbq/seasons/2021/nationals#championship-division]({{ site.url }}{{ site.baseurl }}/tbq/seasons/2021/nationals#championship-division)

For the Challenger Division, real-time results are at [{{ site.url }}{{ site.baseurl }}/tbq/seasons/2021/nationals#challenger-division]({{ site.url }}{{ site.baseurl }}/tbq/seasons/2021/nationals#challenger-division). (Please note that the "Ghost Team" that appears at the top of the standings is a filler for the bye-round situation and should be disregarded.)
