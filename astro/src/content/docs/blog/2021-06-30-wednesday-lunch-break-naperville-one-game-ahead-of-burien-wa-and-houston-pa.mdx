...
Complete results will be available at the end Round 17, which completes Wednesday's play. For live results, go to [{{ site.url }}{{ site.baseurl }}/tbq/seasons/2021/nationals#preliminary-results]({{ site.url }}{{ site.baseurl }}/tbq/seasons/2021/nationals#preliminary-results).
